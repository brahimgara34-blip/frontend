  ...
  return (
    <div className="max-w-3xl mx-auto bg-white border border-[#E8E0D5] rounded-3xl p-6 md:p-10 shadow-sm space-y-6 text-xs md:text-sm text-[#8B8176] leading-relaxed">
      ...
      <div className="space-y-4">
        <div>
          <h2 className="text-base font-bold text-[#5C6B4F] mb-1">1. مدة التوصيل وتكلفته بالمغرب:</h2>
          <p>
        ...
        <div>
          <h2 className="text-base font-bold text-[#5C6B4F] mb-1">2. حق المعاينة والفحص قبل الدفع:</h2>
          <p>
        ...
        <div>
          <h2 className="text-base font-bold text-[#5C6B4F] mb-1">3. التنسيق الهاتفي وموعد التسليم:</h2>
          <p>
